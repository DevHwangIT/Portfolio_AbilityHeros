...
public class Ability_1002 : Ability
{
    public Ability_1002()
    {
        //순차,능력이름,능력정보,소비소울,랭크,스킬타입,쿨타임 등을 설정.
        Index = 1002;
        Name_Key = "Ability_1002_Name";
        Skill_Level = 1;
        Info_Key = "Ability_1002_Info";
        Spend_Soul = 3;
        Rank = Skill_Rank.A;
        Type = Skill_Type.Active_Skill;
        Elemental = Skill_Elemental.Light;
        Skill_Delay = 30;
        Damege = 40 + (Skill_Level * 10);
        Keep_Time = 0;
    }
    ...
    {
        PhotonNetwork.Instantiate("Skill_\\Skill_Resources\\Lightning", Character_State.Instance.gameObject.transform.position, Character_State.Instance.gameObject.transform.rotation, 0); //돌맹이 객체 생성 후 던짐
