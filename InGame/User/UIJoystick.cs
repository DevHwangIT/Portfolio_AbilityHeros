...
public class UIJoystick : MonoBehaviour {
    ...
    {
        if (move.Instance.Is_Trigger == true || move.Instance.Press_Btn == true || move.Instance.isGard == true)
        {
            move.Instance.moveDirection = Vector3.zero;
            move.Instance.joystick_axis = Vector3.zero;
            tapCount = 0;
            return;
        }
    ...
    void OnDrag(Vector2 delta)
    {
        ...
        if (normalize)
        {
            ...
            move_Script.joystick_axis = -position;
        }
    }
